...
// Callbacks pour la modification admin
...
// Callbacks pour la suppression admin
void on_button_supprimer_equip_admin_clicked(GtkButton *button, gpointer user_data);

// Callback pour le double-clic sur le TreeView admin
void on_treeview_listeequipements_admin_row_activated(GtkTreeView *treeview, 
                                                       GtkTreePath *path, 
                                                       GtkTreeViewColumn *column, 
                                                       gpointer user_data);

// Callbacks pour l'espace entraineur
void on_button_chercher_mescoursid_entraineur_clicked(GtkButton *button, gpointer user_data);

// Callbacks pour la réservation d'équipements
...
// Callbacks pour window_equip_dispo_trainer
...
// Callbacks pour window_equip_reserve_trainer
...
// Callbacks pour window_depassement_nombre
...
// NEW: Add missing callback declarations for admin space
...
void on_radiobutton_tri_nom_toggled(GtkToggleButton *button, gpointer user_data);
void on_checkbutton_Centres_ouverts_filtrage_toggled(GtkToggleButton *button, gpointer user_data);
...
void on_radiobutton_tri_ville_toggled(GtkToggleButton *button, gpointer user_data);
...
void on_radiobutton_filtre_payant_event_admin_toggled(GtkToggleButton *button, gpointer user_data);
void on_radiobutton_filtre_gratuit_event_admin_toggled(GtkToggleButton *button, gpointer user_data);
...
// NEW: Add missing callback declarations for trainer space
...
void on_checkbutton_Centres_ouverts_filtrage_entraineur_toggled(GtkToggleButton *button, gpointer user_data);
void on_radiobutton_tri_nom_entraineur_toggled(GtkToggleButton *button, gpointer user_data);
void on_radiobutton_tri_ville_entraineur_toggled(GtkToggleButton *button, gpointer user_data);
...
// NEW: Add missing callback declarations for member space
void on_button_chercher_cours_membre_clicked(GtkButton *button, gpointer user_data);
void on_radiobutton_debutant_cours_membre_toggled(GtkToggleButton *button, gpointer user_data);
void on_radiobutton_intermidiaire_cours_membre_toggled(GtkToggleButton *button, gpointer user_data);
...
void on_radiobutton_avance_cours_membre_toggled(GtkToggleButton *button, gpointer user_data);
...
void on_radiobutton_filtre_gratuit_membre_toggled(GtkToggleButton *button, gpointer user_data);
void on_radiobutton_filtre_payant_event_membre_toggled(GtkToggleButton *button, gpointer user_data);
...
// NEW: Add missing callback declarations for admin windows
...
// NEW: Add missing callback declarations for trainer windows
void on_button_inscri_confirmer_trainer_clicked(GtkButton *button, gpointer user_data);
void on_treeview__mesinscriptions_centre_trainer_row_activated(GtkTreeView *treeview, GtkTreePath *path, GtkTreeViewColumn *column, gpointer user_data);
void on_checkbutton_mesinscri_selectall_trainer_toggled(GtkToggleButton *button, gpointer user_data);
...
// NEW: Add missing callback declarations for member windows
...
void on_checkbutton_selectout_mescours_membre_toggled(GtkToggleButton *button, gpointer user_data);
...
void on_checkbutton_selectionner_toutentraineur_membre_toggled(GtkToggleButton *button, gpointer user_data);
...
void on_checkbutton_selectall_event_membre_toggled(GtkToggleButton *button, gpointer user_data);
